		...
		<div id="MainForm">
			<div class="row"> <!-- row -->
               ...
               <div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="First Name" name="first_Person_FName" id="first_Person_FName">	
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-right">
						<input type="text" class="form-control" placeholder="Last Name" name="first_Person_LName" id="first_Person_LName">
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
            </div> <!-- /row -->
            ...
            <div class="row"> <!-- row -->
               <div class="col-12"> <!-- col-12 -->
                ...
                <div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="First Name" name="second_Person_FName" id="second_Person_FName">	
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-right">
						<input type="text" class="form-control" placeholder="Last Name" name="second_Person_LName" id="second_Person_LName">
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
            </div> <!-- /row -->
