                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xs-12"> <!--Lift First Internal row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="First Name" name="pallFName" id="pallFName">	
                                </div>
                                <br/>
                            ...
                            <div class="col-lg-6 col-xs-12"> <!--Right First Internal row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="Last Name" name="pallLName" id="pallFName">	
                                </div>
                    ...
                    <div class="col-lg-6 xs-col-12"> <!--Upper lift part of lift part of the container -->
                        ...
                        <div class="row"><!--Third Internal Row -->
                            ...
                            <div class="col-lg-6 col-xs-12">
                                ...
                                <h5 style=" color:green;" class="push-left">Old Testament</h5>
                            </div>
                        ...
                        <div class="row"><!--sixth Internal Row -->
                            <div class="col-lg-6 col-xs-12"><!--Lift side of sixth Internal Row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="First Name" name="fReadingFName" id="fReadingFName">	
                                </div>
                                <br/>
                            </div><!--End Lift side of sixth Internal Row -->
                            <div class="col-lg-6 col-xs-12"><!--Right side of sixth Internal Row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="Last Name" name="fReadingLName" id="fReadingLName">	
                                </div>
                    ...
                    <div class="col-lg-6 xs-col-12"><!-- Upper Right part of lift part of the container -->
                        ...
                        <div class="row"><!--Third Internal Row -->
                            ...
                            <div class="col-lg-6 col-xs-12">
                                ...
                                <h5 style=" color:green;" class="push-left">New Testament</h5>
                            </div>
                        ...
                        <div class="row"><!--Sixth Internal Row -->
                            <div class="col-lg-6 col-xs-12"><!--Lift side of Sixth Internal Row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="First Name" name="sReadingFName" id="sReadingFName">	
                                </div>
                                <br/>
                            </div><!--End Lift side of Sixth Internal Row -->
                            <div class="col-lg-6 col-xs-12"><!--Lift side of Sixth Internal Row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="Last Name" name="sReadingLName" id="sReadingLName">	
                                </div>
                                <br/>
                            </div><!--END Lift side of Sixth Internal Row -->
                        </div>			 
                ...
                <div class="row"><!-- Third row of the container-->
                    <div class="col-lg-12 col-xs-12"><!--Third row lift part of the container-->
                            ...
                            <br/><br/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-xs-12">
                                        <div class="input-group input-group-lg push-left">
                                            <input type="text" class="form-control" placeholder="First Name" name="p_of_f_Reader_FName" id="p_of_f_Reader_FName">	
                                        </div>
                                        <br/>
                                    </div>
                                    <div class="col-lg-5 col-xs-12">
                                        <div class="input-group input-group-lg push-left">
                                            <input type="text" class="form-control" placeholder="Last Name" name="p_of_f_Reader_LName" id="p_of_f_Reader_LName">	
                                        </div>
										<br/>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-xs-12">
                                <div class="push-left">
                                    <input type="submit" class="btn btn-lg btn-block btn-green" formaction="InitialInformation.php" value="Previous">
                                </div>
                                <br/>
                            </div>
                            <div class="col-lg-3 col-xs-12">
