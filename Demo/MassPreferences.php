...
<!--	
		Author: Luis Gomez  ~ Demo/MassPreferences.php ~ Demo Forms
...
mysqli_set_charset($conn, "utf8");
		...
		echo($_SESSION['dec_first_Name']) . " <-Testing";
		echo $_SESSION['dec_last_Name'] . " <-Testing";
        ?>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xs-12"> <!--Lift First Internal row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="First Name" name="temp" id="temp" value="Jack" disabled>	
                                </div>
                                <br/>
                            ...
                            <div class="col-lg-6 col-xs-12"> <!--Right First Internal row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="Last Name" name="temp" id="temp" value="Hawk" disabled>	
                                </div>
       ...
       echo "</option>";
                        ...
                        <div class="row"><!--sixth Internal Row -->
                            <div class="col-lg-6 col-xs-12"><!--Lift side of sixth Internal Row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="First Name" name="temp" id="temp" value="Anna" disabled>	
                                </div>
                                <br/>
   ...
   while ($row = $result->fetch_assoc()) {
       ...
       echo "</option>";
                        ...
                        <div class="row"><!--Sixth Internal Row -->
                            <div class="col-lg-6 col-xs-12"><!--Lift side of Sixth Internal Row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="First Name" name="temp" id="temp" value="Sam" disabled>	
                                </div>
                                <br/>
                            </div><!--End Lift side of Sixth Internal Row -->
                            <div class="col-lg-6 col-xs-12"><!--Lift side of Sixth Internal Row -->
                                <div class="input-group input-group-lg push-left">
                                    <input type="text" class="form-control" placeholder="Last Name" name="temp" id="temp" value="Garcia" disabled>	
                                </div>
                                <br/>
                            </div><!--END Lift side of Sixth Internal Row -->
                        </div>			 
   ...
   while ($row = $result->fetch_assoc()) {
       ...
       echo "</option>";
                            ...
                            <br/><br/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-xs-12">
                                        <div class="input-group input-group-lg push-left">
                                            <input type="text" class="form-control" placeholder="First Name" name="temp" id="temp" value="Vicky" disabled>	
                                        </div>
                                        <br/>
                                    </div>
                                    <div class="col-lg-5 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-xs-12">
                                <div class="push-left">
                                    <input type="submit" class="btn btn-lg btn-block btn-green" value="Previous" formaction="InitialInformation.php">
                                </div>
                                <br/>
                            </div>
                            <div class="col-lg-3 col-xs-12">
