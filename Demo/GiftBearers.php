...
<!--	
		Author: Luis Gomez  ~ Demo/GiftBearers.php ~ Demo Forms
		...
		<div id="MainForm">
			<div class="row"> <!-- row -->
               ...
               <div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="First Name" name="temp" value="William" id="temp" disabled>	
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-right">
						<input type="text" class="form-control" placeholder="Last Name" value="Garcia" name="temp" id="temp" disabled>
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
            </div> <!-- /row -->
            ...
            <div class="row"> <!-- row -->
               <div class="col-12"> <!-- col-12 -->
                ...
                <div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="First Name" name="temp" value="Bryan"id="temp" disabled>	
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-right">
						<input type="text" class="form-control" placeholder="Last Name" name="temp" value="Hawk" id="temp" disabled>
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
            </div> <!-- /row -->
