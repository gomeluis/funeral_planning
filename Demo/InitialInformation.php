...
?>
<!--	
		Author: Luis Gomez  ~ Demo/InitialInformation.php ~ Demo Forms
			- All Demo inputs/defaults were created by Luis
			
		Description: Demos have default information to show people the general idea on how to fill out the forms
		...
		<div id="MainForm">
			<div class="row"> <!-- row -->
				...
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 --><h5 class="push-left">Deceased's First Name</h5>
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="First Name" name="dec_first_Name" id="dec_first_Name" value="Hank" disabled>	
							<?php
								$_SESSION['dec_first_Name'] = $_REQUEST['dec_first_Name'];
				...
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					...
					<div class="input-group input-group-lg push-right">
						<input type="text" class="form-control" placeholder="Last Name" name="dec_last_Name" id="dec_last_Name" value="Hill" disabled>
							<?php
								$_SESSION['dec_last_Name'] = $_REQUEST['dec_last_Name'];
                ...
                <h5 class="push-left">Gender</h5>
					<div class="input-group input-group-lg push-left">
						<select class="form-control" name="dec_Gender" disabled>
                        <option value="" >Select</option>
							<option value="temp" name="male" id="male" selected>Male</option>
							<option value="temp" name="female" id="female">Female</option>
						</select>
						
						<?php
								if(isset($_REQUEST['dec_Gender']))
									{
										$_SESSION['dec_Gender'] = $_REQUEST['dec_Gender'];
				...
				<div class="col-12"> <!-- col-12 -->
					<div class="input-group input-group-lg push-right push-left">
						<input type="text" class="form-control" placeholder="Address" id="dec_Address" name="dec_Address" value="1234 W Apple Lane" disabled >
						<?php
								if(isset($_REQUEST['dec_Address']))
									{
										$_SESSION['dec_Address'] = $_REQUEST['dec_Address'];
				...
				<div class="col-12 col-sm-4"> <!-- col-12 col-ms-4 -->
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="City" id="dec_City" name="dec_City" value="Chicago" disabled>
						<?php 
							  $dec_City = $_REQUEST['dec_City'];
							  $_SESSION['dec_City'] = $dec_City;
						?>
					</div>
				<br>
				</div> <!-- /col-12 /col-ms-4 -->
				...
				<div class="col-12 col-sm-4"> <!-- col-12 col-sm-4 -->
					<div class="input-group input-group-lg push-right">
						<input type="text" class="form-control" placeholder="Zipcode" id="temp" name="temp" value="60641"disabled>
					</div>
				<br>
				<br>
				</div> <!-- /col-12 /col-ms-4 -->				
				...
				<div class="col-12 col-sm-6 col-md-4"> <!-- col-12 col-sm-6 col-md-4 -->
					<div class="form-group input-group-lg push-left">
						<input type="date" class="form-control" placeholder="Select Date" id="temp" name="temp" value="2018-02-12" disabled>
					</div>
				<br>
				<br>
				</div> <!-- /col-12 /col-sm-6 /col-md-4 -->
			...
			<div class="row"> <!-- row -->
                ...
                <h5 class="push-left">Contact's First Name</h5>
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="First Name" name="temp" id="temp" value="Jimmy" disabled>	
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
                <h5 class="push-right">Last Name</h5>
					<div class="input-group input-group-lg push-right">
						<input type="text" class="form-control" placeholder="Last Name" name="temp" id="temp" value="Smith" disabled>
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
				<div class="col-12 col-sm-6 col-md-4"> <!-- col-12 col-sm-6 col-md-4 -->
					...
					<div class="input-group input-group-lg push-left">
                        ...
                        <option value="" disabled>Select</option>
							...
							<option value="temp" name="temp" id="temp" selected>Sibling</option>
				...
				<div class="col-12"> <!-- col-12 -->
					<div class="input-group input-group-lg push-right push-left">
						<input type="text" class="form-control" placeholder="Address" id="temp" name="temp" value="2134 N. Lemon Ave" disabled>
					</div>
				<br>
				</div> <!-- /col-12 -->
				<div class="col-12 col-sm-4"> <!-- col-12 col-ms-4 -->
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="City" id="temp" name="temp" value="Chicago" disabled>
					</div>
				<br>
				</div> <!-- /col-12 /col-ms-4 -->
				<div class="col-12 col-sm-4"> <!-- col-12 col-ms-4 -->
				...
				<div class="col-12 col-sm-4"> <!-- col-12 col-ms-4 -->
					<div class="input-group input-group-lg push-right">
						<input type="text" class="form-control" placeholder="Zipcode" id="temp" name="temp" value="60642" disabled>
					</div>
				<br>
				<br>
				</div> <!-- /col-12 /col-ms-4 -->
				...
				<div class="col-12 col-md-6"> <!-- col-12 col-md-6 -->
					<div class="input-group input-group-lg push-left push-right">
						<input type="email" class="form-control" id="temp" name="temp" placeholder="Email" value="jimmysmith@gmail.com" disabled>
					</div>
					<br>
				</div> <!-- /col-12 /col-md-6 -->	
				<div class="col-12 col-md-6"> <!-- col-12 col-md-6 -->
					<div class="input-group input-group-lg push-left push-right">
						<input type="text" class="form-control" name="temp" id="temp" placeholder="Phone" value="773-258-7895" disabled>
					</div>
					<br>
					<br>
				</div> <!-- /col-12 /col-md-6 -->				
			...
			<div class="row"> <!-- row -->
				...
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-left">
						<input type="text" class="form-control" placeholder="First Name" name="temp" id="temp" value="Tom" disabled>	
					</div>
				<br>
				</div> <!-- /col-12 /col-sm-6 -->
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
				...
				<div class="col-12 col-sm-6"> <!-- col-12 col-sm-6 -->
					<div class="input-group input-group-lg push-left">
						<select class="form-control">
                        <option value="" disabled>Select</option>
							<option value="temp" name="temp" id="temp" selected>Son</option>
							<option value="temp" name="temp" id="temp">Daughter</option>
							<option value="temp" name="temp" id="temp">Grandchild</option>
                            <option value="temp" name="temp" id="temp">Friend</option>
							<option value="temp" name="temp" id="temp">Mother</option>
				...
				<br>
 				...
 				<div class="col-12 col-md-6"> <!-- col-12 col-md-6 -->
 					<div class="push-right push-left">
 						<input type="submit" class="btn btn-lg btn-block btn-green" value="Next" name="submit" >
					</div>
					<br>
 				</div> <!-- /col-12 /col-md-6 -->
 			</div> <!-- /row -->
