...
<!--	
		Author: Luis Gomez  ~ Demo/PersonalReminiscenses.php ~ Demo Forms
...
<div class="container"> <!-- container -->
	<form action="FinalReview.php" method="post">
             ...
             <div class="row"> <!-- row -->
                ...
                <div class="col-12 pull-md-6 col-md-6"> <!-- col-12 col-md-6 -->
 					<div class="push-right push-left" id="btnPrev">
 						<input type="button" class="btn btn-lg btn-block btn-green"  formaction="MusicSelection.php" value="Previous">
					</div>
					<br>
 				</div> <!-- /col-12 /col-md-6 -->
 			</div> <!-- /row -->
